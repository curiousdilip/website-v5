        ...
        <div className="skills">
          ...
          >
            <div className="skill-card">
              <div className="icon">
                <svg width="42" height="42" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M5.369 37.814 2 0h37.038L35.67 37.794 20.49 42" fill="#E44D26"></path><path d="M20.519 38.785V3.104h15.14l-2.89 32.26" fill="#F16529"></path><path d="M8.88 7.729h11.64v4.634h-6.555l.429 4.748h6.125v4.624H10.147L8.88 7.73Zm1.471 16.334h4.655l.327 3.706 5.186 1.388v4.84l-9.515-2.655" fill="#EBEBEB"></path><path d="M32.116 7.729H20.5v4.634h11.189l.428-4.634Zm-.847 9.382H20.5v4.634h5.717l-.542 6.024-5.175 1.388v4.819l9.494-2.634" fill="#fff"></path></svg>
              </div>
